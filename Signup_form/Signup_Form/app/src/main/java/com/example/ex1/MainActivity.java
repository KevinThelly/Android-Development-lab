...
//    Spinner spin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marriage=findViewById(R.id.spin);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("marriage",marriage.getSelectedItem().toString());
                i.putExtra("Hour",time.getCurrentHour().toString());
                i.putExtra("Min",time.getCurrentMinute().toString());
                if(ch1.isChecked()){
                    lan = lan+"smoking";
                }
